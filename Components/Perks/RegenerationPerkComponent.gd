...
@export var extra_regeneration: float
...
func apply_modifiers() -> void:
	...
	set_minor_stat("[color=crimson]Passive Regeneration:[/color] " + str(regeneration + extra_regeneration), "additive_regeneration")
...
func _regenerate():
	...
	health_component.set_health(health_component.health + regeneration + extra_regeneration)
